...
from ASOkai.Sites import GenomicSite
...
class TestTargetGeneSerialization:
    ...
    def test_metadata_present(self, sample_target_gene):
        ...
        assert data['__module__'] == 'ASOkai.Targets._target_gene'
...
class TestTargetGeneDeserialization:
    ...
    def test_from_dict_with_flattened_locus(self, sample_sequence):
        ...
        data = {
            ...
            '__module__': 'ASOkai.Targets._target_gene',
            'id': 'ENSG00000001',
            'name': 'TEST_GENE',
            'chr': '12',
            'start': 100,
        ...
        data = {
            ...
            'sites': {
                'site1': {
                    ...
                    '__module__': 'ASOkai.Sites._genomic_site',
                    'id': 'site1',
                    'chr': '12',
                    'start': 100,
                    'end': 115,
